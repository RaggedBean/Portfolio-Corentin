...
doc2.addEventListener("mouseenter", () => {doc2.innerHTML="l'augmantation du nucléaire"});
doc2.addEventListener("mouseleave", () => {doc2.innerHTML="la sortie du nucléaire"});

const doc3 = document.querySelector("#hidden-text3");

doc3.addEventListener("mouseenter", () => {doc3.innerHTML="proposer des repas locaux et de qualités aux élèves dans les écoles"});
